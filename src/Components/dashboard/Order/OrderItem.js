...
import "../../../css/dashboard/Order/orderitem.css";
...
export default function OrderItem(props) {
    ...
    const handleRejectionFormSubmit = async (e) => {
        ...
        const response = await fetch("http://51.20.54.146/orders/orderconfrej", {
            method: "PATCH",
            headers: {
    ...
    const readyHandler = async (role) => {
        ...
        const response = await fetch("http://51.20.54.146/orders/orderReady", {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
                "Authorization": "Bearer " + localStorage.getItem('token')
    ...
    const deliverHandler = async (role) => {
        ...
        const response = await fetch("http://51.20.54.146/orders/deliverOrder", {
            method: "PATCH",
            headers: {
                "Content-Type": "application/json",
                "Authorization": "Bearer " + localStorage.getItem('token')
